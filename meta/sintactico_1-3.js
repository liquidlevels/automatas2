...
function isSpecialCharacter(letter){
    return special_char.some(character => character == letter) == true ? true : false
}

function isLetterFromAlphabet(letter){
    return alphabet.some(character => character == letter) == true ? true : false
}

function isNumber(num){
   return number.some(character => character == num) == true ? true : false
}
